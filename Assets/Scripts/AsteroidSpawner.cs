...
public class AsteroidSpawner : MonoBehaviour
{
    ...
    [SerializeField] private float spawnRateBySeconds = 0.85f;
    [SerializeField] private Vector2 forceRange;
    [SerializeField] private int numOfAsteroidsUntilIncrease;
    private int count = 0;
    ...
    void Update()
    {
        ...
        if(count/numOfAsteroidsUntilIncrease==1){spawnRateBySeconds-=0.05f;
        count=0;}
    }
